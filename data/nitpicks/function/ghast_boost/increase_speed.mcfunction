...
scoreboard players set @e[type=minecraft:happy_ghast,limit=1,sort=nearest] ghast_boost 3600

# Remove effect
execute as @e[type=minecraft:happy_ghast,limit=1,sort=nearest] run schedule function nitpicks:ghast_boost/decrease_speed 180s append
